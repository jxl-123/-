...
Page({
  ...
  getWeather: function (cityName) {
    ...
    var BMap = new bmap.BMapWX({
      ak: 'dGugevMyq7rghlUmAqGj0nb9mGbPGC5n'
    });
    ...
    var success = function (data) {
      ...
      wx.request({
        url: 'https://api.heclouds.com/devices/576678468/datapoints',
        method: "POST",
        header: {
          "api-key": "GQQ3WhA142xmqr6qmlbbdVATlMs="
        },
        data: {
          "datastreams": [{
            "id": "temp1",
            "datapoints": [{ "value": currentWeather.date }]
          }]
        },
        success(res) {
